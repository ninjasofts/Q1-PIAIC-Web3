...
let famous_quote: string ="A person who never made a mistake never tried anything new.";
...
console.log("Task 5:");
let famous_person: string="Muhammad Ahmed Raza";
let message: string="Self Expoloration is an ongoing process.";
...
console.log("Task 6:");
let person_name: string="Muhammad Ahmed Raza";
...
console.log("Task 11:");
let friends: string[] = ["Usman", "Badar", "Faizan"];
...
console.log("Task 12:");
let friends_name: string[] = ["Usman", "Badar", "Faizan"];
...
console.log("Task 13");
let vehicles: string[] = ["Honda Vezel", "Revo", "Aqua"];
...
console.log("Task 14");
let guests: string[] = ["Usman", "Hassan", "Tahir Raza"];
...
console.log("Task 18");
let placesToVisit: string[] = ["Swat", "Karachi", "Bawalpur", "Neelum", "Chakwal"];
...
console.log("Task 20");
let mountains: string[] = ["Everest", "K2", "NangaParbat"];
console.log("Mountains: " + mountains);

let rivers: string[] = ["Sindh", "Chanab", "Jhelum"];
console.log("Rivers: " + rivers);

let countries: string[] = ["Pakistan", "China", "India", "Australia"];
console.log("Countries: " + countries);

let cities: string[] = ["Islamabad", "Kharian", "Dina", "Sydney"];
console.log("Cities: " + cities);

let languages: string[] = ["English", "Urdu", "Punjabi", "Arabic"];
...
let roll_numbers: number[] = [509, 510, 511];
...
console.log("Task 29");
let favorite_fruits: string[] = ["apple", "banana", "pineapple"];
...
console.log("Task 30");
let usernames: string[] = ['admin', 'ahmed', 'sajid', 'khurram', 'badar'];
...
console.log("Taks 32");
let current_users: string[] = ['Ahmed', 'Ali', 'Musa', 'Sara', 'Tania'];
let new_users: string[] = ['Bashir', 'Ali', 'Usman', 'Sara', 'Samia'];
...
console.log("Taks 34");
let pizzas: string[] = ['Pepperoni', 'Margherita', 'Special'];
...
console.log("Taks 41");
let magician: string[]= ["Akram", "Hamoon", "Nastoor"];
...
console.log("Taks 42");
function make_great(add_great: string[]) {
  for (let i = 0; i < add_great.length; i++) {
    add_great[i] += " the Great";
  }
  return add_great;
}
let greatMags: string[] = make_great(magician);
...
let orig_names: string[] = [];
for(let i=0; i>magician.length; i++){
console.log(magician[i]);
}

let magicians: string[] = ["Magician 1", "Magician 2", "Magician 3"];
let newMagicians: string[] = make_great(magicians.slice());
